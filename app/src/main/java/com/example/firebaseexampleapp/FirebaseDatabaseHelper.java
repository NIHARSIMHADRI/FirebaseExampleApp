...
import com.example.firebaseexampleapp.Event;
...
public class FirebaseDatabaseHelper {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot item: dataSnapshot.getChildren()) {
                    Event e = new Event(
                            ...
                            item.child("eventDescription").getValue().toString(),
    ...
    public void updateEvent(String key, String eventName, String eventDescription, String eventDate, int month, int day, int year) {
